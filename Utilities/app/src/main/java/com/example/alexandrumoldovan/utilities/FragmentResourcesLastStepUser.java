...
public class FragmentResourcesLastStepUser extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((ActivityUser) getActivity()).setActionBarTitle("Last step");
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        resources = inflater.inflate(R.layout.layout_resources_last_step_reports_user, container, false);
